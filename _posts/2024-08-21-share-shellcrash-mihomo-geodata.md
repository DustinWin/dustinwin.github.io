...
5. 若 `谷歌服务` 出现错误如 [Google Chrome](https://www.google.com/chrome/) 检查更新失败，请删除 `direct-nameserver` 配置项里的[阿里云公共 DNS](https://help.aliyun.com/zh/dns/what-is-alibaba-cloud-public-dns)
...
dns:
  ...
  nameserver-policy:
    ...
    'geosite:microsoft-cn,apple-cn,google-cn,games-cn,private,cn':
      - https://doh.pub/dns-query
      - quic://dns.alidns.com:853
```
