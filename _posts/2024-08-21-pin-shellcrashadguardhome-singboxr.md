...
3. 安装 [sing-box reF1nd 版内核](https://github.com/reF1nd/sing-box)和 AdGuard Home 时须注意路由器 CPU 架构，查看 CPU 架构可连接 SSH 后执行命令 `uname -ms`，若执行结果是“linux aarch64”，就下载 arm64 版安装包；若是其它架构请下载相匹配的安装包
