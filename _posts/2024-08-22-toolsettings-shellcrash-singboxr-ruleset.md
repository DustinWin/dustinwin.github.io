...
9. 进入主菜单 → 6 导入配置文件 → 2 在线获取配置文件，粘贴《[生成带有自定义出站和规则的 sing-boxr 配置文件直链-ruleset 方案](https://proxy-tutorials.dustinwin.us.kg/posts/link-singboxr-ruleset)》中生成的 .json 配置文件直链，启动服务即可
